...
// 受け取ったpayloadだけで1ターン返す（CommonJS / Vercel Functions向け）
...
module.exports = async function handler(req, res) {
    try {
      ...
      const lastNpcText = String((body.last && body.last.npcText) || '').trim();
      const lastPlayerText = String((body.last && body.last.playerText) || '').trim();
