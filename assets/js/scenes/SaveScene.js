...
import { defaultSave, loadSave, storeSave, saveSlotName } from '../core/save.js';
...
export class SaveScene extends Phaser.Scene {
  ...
  create(){
    ...
    this.body = this.add.text(100, 560, `${saveSlotName(s)}  HP ${s.player.hp}/${s.player.maxHp}`, { fontSize:'24px', color:'#fff' }).setShadow(2,2,'#000',2);
